...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_tmp_id PRIMARY KEY,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_alias_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_group_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_member_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_name_variation_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_url_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    url              VARCHAR (5000),
...
(
    name VARCHAR (255) NOT NULL CONSTRAINT pk_genre_tmp_name PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS label_tmp
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_tmp_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_sub_label_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_url_tmp_id PRIMARY KEY
    ,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    url              VARCHAR (5000),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_tmp_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    data_quality     VARCHAR (255),
    title            VARCHAR (2000),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_artist_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_genre_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    genre            VARCHAR (255),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_video_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id                  SERIAL NOT NULL CONSTRAINT pk_release_item_tmp_id
        PRIMARY KEY,
    created_at          TIMESTAMP NOT NULL,
    last_modified_at    TIMESTAMP NOT NULL,
    country             VARCHAR (255),
...
(
    id                SERIAL NOT NULL CONSTRAINT pk_label_item_release_tmp_id
        PRIMARY KEY,
    created_at        TIMESTAMP NOT NULL,
    last_modified_at  TIMESTAMP NOT NULL,
    label_id          SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_artist_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT
        pk_release_item_credited_artist_tmp_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    role             VARCHAR (20000),
    artist_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_genre_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    genre            VARCHAR (255),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_video_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_work_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    work             VARCHAR (5000),
...
(
    name VARCHAR (255) NOT NULL CONSTRAINT pk_style_tmp_name PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS master_style_tmp
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_style_tmp_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    master_id        SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_style_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    release_item_id  SERIAL NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_track_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_format_tmp_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    name             VARCHAR (2000),
...
(
    id               SERIAL NOT NULL CONSTRAINT
        pk_release_item_identifier_tmp_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
