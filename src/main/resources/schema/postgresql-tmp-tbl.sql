...
(
    ...
    NULL
    CONSTRAINT
    pk_artist_name_variation_tmp_id
    PRIMARY
    KEY,
    created_at
    TIMESTAMP
...
(
    ...
    NULL
    CONSTRAINT
    pk_release_item_credited_artist_tmp_id
    PRIMARY
    KEY,
    created_at
    TIMESTAMP
...
(
    ...
    NULL
    CONSTRAINT
    pk_release_item_identifier_tmp_id
    PRIMARY
    KEY,
    created_at
    TIMESTAMP
