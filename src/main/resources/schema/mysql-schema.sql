...
(
    ...
    label_id         BIGINT NOT NULL,
    release_item_id  BIGINT NOT NULL,
    CONSTRAINT uq_release_item_work_release_item_id_label_id_work UNIQUE ( release_item_id, label_id, `work` ( 100 )),
...
(
    ...
    release_item_id BIGINT NOT NULL,
    CONSTRAINT uq_release_item_track_position_title_duration_release_item_id UNIQUE ( `position` ( 100 ), title ( 100 ), duration ( 100 ), release_item_id ),
...
(
    ...
    CONSTRAINT fk_release_item_master_release_item_id_release_item FOREIGN KEY ( release_item_id ) REFERENCES release_item ( id ),
    CONSTRAINT fk_release_item_master_master_id_master FOREIGN KEY ( master_id ) REFERENCES master ( id ),
    CONSTRAINT pk_release_item_master_id PRIMARY KEY ( id )
);
