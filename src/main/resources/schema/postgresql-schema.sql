CREATE TABLE IF NOT EXISTS artist (
    id               SERIAL NOT NULL CONSTRAINT pk_artist_id PRIMARY KEY,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_alias_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    alias_id         SERIAL NOT NULL CONSTRAINT fk_artist_alias_alias_id_artist
        REFERENCES
            artist,
    artist_id        SERIAL NOT NULL CONSTRAINT
        fk_artist_alias_artist_id_artist REFERENCES
            artist,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_group_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL CONSTRAINT
        fk_artist_group_artist_id_artist REFERENCES
            artist,
    group_id         SERIAL NOT NULL CONSTRAINT fk_artist_group_group_id_artist
        REFERENCES
            artist,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_member_id PRIMARY KEY
    ,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL CONSTRAINT
        ...
        REFERENCES artist,
    member_id        SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_name_variation_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    ...
    artist_id        SERIAL NOT NULL CONSTRAINT
        ...
        REFERENCES artist,
    CONSTRAINT uq_artist_name_variation_artist_id_name_variation UNIQUE (
                                                                         artist_id, name_variation )
);

CREATE TABLE IF NOT EXISTS artist_url
(
    id               SERIAL NOT NULL CONSTRAINT pk_artist_url_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    url              VARCHAR (5000),
    artist_id        SERIAL NOT NULL CONSTRAINT fk_artist_url_artist_id_artist
        REFERENCES
            artist,
...
(
    etag          VARCHAR (255) NOT NULL CONSTRAINT pk_discogs_dump_id PRIMARY
        KEY,
    created_at    DATE,
...
(
    name VARCHAR (255) NOT NULL CONSTRAINT pk_genre_name PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS label
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_sub_label_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    parent_label_id  SERIAL NOT NULL CONSTRAINT
        fk_label_sub_label_parent_label_id_label REFERENCES label,
    sub_label_id     SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_label_url_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    url              VARCHAR (5000),
    label_id         SERIAL NOT NULL CONSTRAINT fk_label_url_label_id_label
        REFERENCES label,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    data_quality     VARCHAR (255),
    title            VARCHAR (2000),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_artist_id PRIMARY KEY
    ,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL CONSTRAINT
        ...
        REFERENCES artist,
    master_id        SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_genre_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    genre            VARCHAR (255) CONSTRAINT fk_master_genre_genre_genre
        REFERENCES genre,
    master_id        SERIAL NOT NULL CONSTRAINT
        fk_master_genre_master_id_master REFERENCES
            master,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_video_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    ...
    url              VARCHAR (5000),
    master_id        SERIAL NOT NULL CONSTRAINT
        fk_master_video_master_id_master REFERENCES
            master,
...
(
    id                  SERIAL NOT NULL CONSTRAINT pk_release_item_id PRIMARY
        KEY,
    created_at          TIMESTAMP NOT NULL,
    last_modified_at    TIMESTAMP NOT NULL,
    country             VARCHAR (255),
...
(
    id                SERIAL NOT NULL CONSTRAINT pk_label_item_release_id
        PRIMARY KEY,
    created_at        TIMESTAMP NOT NULL,
    last_modified_at  TIMESTAMP NOT NULL,
    label_id          SERIAL NOT NULL CONSTRAINT
        fk_label_item_release_label_id_label
        REFERENCES label,
    release_item_id   SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_artist_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    artist_id        SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT
        pk_release_item_credited_artist_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    role             VARCHAR (20000),
    artist_id        SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_genre_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    genre            VARCHAR (255) CONSTRAINT fk_release_item_genre_genre_genre
        REFERENCES
            genre,
    release_item_id  SERIAL NOT NULL CONSTRAINT
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_video_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_work_id PRIMARY
        KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    work             VARCHAR (5000),
...
(
    name VARCHAR (255) NOT NULL CONSTRAINT pk_style_name PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS master_style
(
    id               SERIAL NOT NULL CONSTRAINT pk_master_style_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    master_id        SERIAL NOT NULL CONSTRAINT
        fk_master_style_master_id_master REFERENCES
            master,
    style            VARCHAR (255) CONSTRAINT fk_master_style_style_style
        REFERENCES style,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_style_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    release_item_id  SERIAL NOT NULL CONSTRAINT
        ...
        REFERENCES release_item,
    style            VARCHAR (255) CONSTRAINT fk_release_item_style_style_style
        REFERENCES
            style,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_track_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_format_id
        PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
    name             VARCHAR (2000),
...
(
    id               SERIAL NOT NULL CONSTRAINT pk_release_item_identifier_id PRIMARY KEY,
    created_at       TIMESTAMP NOT NULL,
    last_modified_at TIMESTAMP NOT NULL,
