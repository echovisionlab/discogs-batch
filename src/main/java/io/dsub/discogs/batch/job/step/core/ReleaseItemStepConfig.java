...
public class ReleaseItemStepConfig extends AbstractStepConfig {
    ...
    public static final String RELEASE_ITEM_SUB_ITEMS_INSERTION_STEP = "release item sub items insertion step";
    ...
    public static final String RELEASE_GENRE_STYLE_INSERTION_STEP = "release genre style insertion step";

    private final SynchronizedItemStreamReader<ReleaseItemSubItemsXML> releaseItemSubItemsStreamReader;
    ...
    private final ItemProcessor<ReleaseItemSubItemsXML, Collection<UpdatableRecord<?>>> releaseItemSubItemsProcessor;
    ...
    public Step releaseItemSubItemsInsertionStep(@Value(CHUNK) Integer chunkSize) {
        return sbf.get(RELEASE_ITEM_SUB_ITEMS_INSERTION_STEP)
                .<ReleaseItemSubItemsXML, Collection<UpdatableRecord<?>>>chunk(Integer.divideUnsigned(chunkSize, 2)) // due to memory consumptions
