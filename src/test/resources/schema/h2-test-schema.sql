...
(
    ...
    CONSTRAINT pk_artist_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    alias_id BIGINT NULL,
    CONSTRAINT pk_artist_alias_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    group_id BIGINT NULL,
    CONSTRAINT pk_artist_group_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    member_id BIGINT NULL,
    CONSTRAINT pk_artist_member_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NOT NULL,
    CONSTRAINT pk_artist_name_variation_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NOT NULL,
    CONSTRAINT pk_artist_url_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    CONSTRAINT pk_genre_tmp_name PRIMARY KEY
(
    name
)
    );
...
(
    ...
    CONSTRAINT pk_label_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    parent_label_id BIGINT NULL,
    sub_label_id BIGINT NULL,
    CONSTRAINT pk_label_sub_label_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    label_id BIGINT NOT NULL,
    CONSTRAINT pk_label_url_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    year SMALLINT NOT NULL,
    main_release_item_id BIGINT NULL,
    CONSTRAINT pk_master_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    master_id BIGINT NULL,
    CONSTRAINT pk_master_artist_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    master_id BIGINT NULL,
    CONSTRAINT master_genre_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    master_id BIGINT NULL,
    CONSTRAINT pk_master_video_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    master_id BIGINT NULL,
    CONSTRAINT pk_release_item_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_format_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_identifier_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    label_id BIGINT NULL,
    release_item_id BIGINT NULL,
    CONSTRAINT pk_label_item_release_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_artist_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    artist_id BIGINT NULL,
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_credited_artist_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_genre_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_video_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    label_id BIGINT NULL,
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_work_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    CONSTRAINT pk_style_tmp_name PRIMARY KEY
(
    name
)
    );
...
(
    ...
    CONSTRAINT pk_master_style_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    CONSTRAINT pk_release_item_style_tmp_id PRIMARY KEY
(
    id
)
    );
...
(
    ...
    release_item_id BIGINT NULL,
    CONSTRAINT pk_release_item_track_tmp_id PRIMARY KEY
(
    id
)
    );
