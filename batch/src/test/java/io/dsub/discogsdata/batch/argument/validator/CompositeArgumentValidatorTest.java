...
class CompositeArgumentValidatorTest {
    ...
    void addValidators() {
        ...
        assertThat(this.compositeArgumentValidator.addValidators(helloValidator, worldValidator))
                .isEqualTo(this.compositeArgumentValidator);
        assertThat(this.compositeArgumentValidator.addValidators(List.of(helloValidator, worldValidator)))
                .isEqualTo(this.compositeArgumentValidator);
    ...
    void afterPropertiesSet() {
        assertThrows(MissingRequiredParamsException.class,
