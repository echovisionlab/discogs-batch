...
class ArgumentPropertyTest {

    @Test
    void builderShouldContainValidInitialValues() {
        ArgumentProperty property = ArgumentProperty.builder()
    ...
    void builderShouldThrowWhenNullValuePassedAsGlobalName() {
        ...
        assertThrows(InvalidArgumentException.class, () -> ArgumentProperty.builder().globalName(null).build());
    }
    ...
    void builderShouldRepresentGivenValues(int min) {
        ...
        List<String> synonyms = List.of(String.valueOf(min),
        ...
        ArgumentProperty props = ArgumentProperty.builder()
                .minValuesCount(min)
    ...
    void containsShouldReturnValidResultIfUnderscoreOrHyphen() {
        ArgumentProperty property = ArgumentProperty
                .builder()
                .globalName("testProperty")
    ...
    void shouldThrowWhenMinValueIsGreaterThanMaxValue(int minValue) {
        int max = 50;
        if (minValue <= max) {
            assertDoesNotThrow(() -> ArgumentProperty.builder()
                    .globalName("test")
                    .minValuesCount(minValue)
                    .maxValuesCount(max)
                    .build());
        } else {
            assertThrows(InvalidArgumentException.class, () -> ArgumentProperty.builder()
                    .globalName("test")
                    .minValuesCount(minValue)
                    .maxValuesCount(max)
                    .build());
    ...
    void shouldHandleNullInvolvedListOrArrayIntoSynonyms() {
        List<String> list = List.of("hi", "there").stream()
        ...
        property = ArgumentProperty.builder()
                .globalName("test")
                .synonyms(list.toArray(String[]::new))
                .build();
        assertThat(property.getSynonyms().size()).isEqualTo(2);
    }
