...
/**
 * Composite argument validator that delegates its validation to list of other validators.
 * Can be used to tread a group of validators as a single validator.
 * Also, a group of validators can also be accumulated accordingly.
 */
