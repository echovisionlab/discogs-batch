...
/**
 * An immutable implementation for the {@link ValidationResult}.
 * The issues will only be accumulated during each validation step.
 * The content and the instance will be virtually immutable.
 */
public class DefaultValidationResult implements ValidationResult {
    ...
    public DefaultValidationResult withIssues(String... issues) {
        ...
        List<String> updated = Arrays.stream(issues)
