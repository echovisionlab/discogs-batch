...
/**
 * Represented result of a validation (mainly by {@link ArgumentValidator}).
 * actual behavior depends on its implementations.
 */
public interface ValidationResult {
     ...
     * The actual behavior will be depends on the implementation.
     *
