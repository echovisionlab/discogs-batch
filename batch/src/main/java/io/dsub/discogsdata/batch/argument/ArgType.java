...
public enum ArgType {
    URL(ArgumentProperty.builder()
            .globalName("url")
            .required(true)
            .build()),
    USERNAME(ArgumentProperty.builder()
            .globalName("username")
            .synonyms("user", "u")
            .required(true)
            .build()),
    PASSWORD(ArgumentProperty.builder()
            .globalName("password")
            .synonyms("password", "pass", "p")
            .required(true)
            .build()),
    TYPE(ArgumentProperty.builder()
            .globalName("type")
            .synonyms("t")
            .maxValuesCount(4)
            .build()),
    CHUNK_SIZE(ArgumentProperty.builder()
            .globalName("chunkSize")
            .supportedType(Long.class)
            .synonyms("chunk", "c")
            .build()),
    THROTTLE_LIMIT(ArgumentProperty.builder()
            .globalName("throttleLimit")
            .synonyms("throttle")
            .supportedType(Long.class)
            .build()),
    YEAR(ArgumentProperty.builder()
            .globalName("year")
            .synonyms("y")
            .supportedType(Long.class)
            .build()),
    YEAR_MONTH(ArgumentProperty.builder()
            .globalName("yearMonth")
            .synonyms("ym")
            .build()),
    E_TAG(ArgumentProperty.builder()
            .globalName("eTag")
            .synonyms("e")
            .maxValuesCount(4)
            .build());
